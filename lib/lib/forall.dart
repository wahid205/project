                  ...
                  child: Stack(
                    children: [
                      ...
                      Positioned(
                        bottom: 20,
                        right: 20,
                        child: Text('${BedPrice[index]} Pound',style: const TextStyle(
                          fontSize: 20,
                  ...
                  child: Stack(
                    children: [
                      ...
                      Positioned(
                        bottom: 20,
                        right: 20,
                        child: Text('${SofaPrice[index]} Pound',style: const TextStyle(
                          fontSize: 20,
                          color:  Color.fromARGB(255, 3, 39, 56),
                        ),))
                    ],
                  ...
                  child: Stack(
                    children: [
                      ...
                      Positioned(
                        bottom: 20,
                        right: 20,
                        child: Text('${MirrorPrice[index]} Pound',style: const TextStyle(
                          fontSize: 20,
                          color:  Color.fromARGB(255, 3, 39, 56),
                        ),))
                    ],
                  ...
                  child: Stack(
                    children: [
                      ...
                      Positioned(
                        bottom: 20,
                        right: 20,
                        child: Text('${DrawerPrice[index]} Pound',style: const TextStyle(
                          fontSize: 20,
                          color:  Color.fromARGB(255, 3, 39, 56),
                        ),))
                    ],
                  ...
                  child: Stack(
                    children: [
                      ...
                      Positioned(
                        bottom: 20,
                        right: 20,
                        child: Text('${LivingPrice[index]} Pound',style: const TextStyle(
                          fontSize: 20,
                          color:  Color.fromARGB(255, 3, 39, 56),
                        ),))
                    ],
                  ...
                  child: Stack(
                    children: [
                      ...
                      Positioned(
                        bottom: 20,
                        right: 20,
                        child: Text('${DiningPrice[index]} Pound',style: const TextStyle(
                          fontSize: 20,
                          color:  Color.fromARGB(255, 3, 39, 56),
                        ),))
                    ],
                  ...
                  child: Stack(
                    children: [
                      ...
                      Positioned(
                        bottom: 20,
                        right: 20,
                        child: Text('${ChairPrice[index]} Pound',style: const TextStyle(
                          fontSize: 20,
                          color:  Color.fromARGB(255, 3, 39, 56),
                        ),))
                    ],
